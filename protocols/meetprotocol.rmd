...
We laden de bestanden van de Google Forms en de Fitbit Takeout samen in **RStudio**. Met behulp van **R-code** gaan we de data onderzoeken.

Heel belangrijk hierbij is dat we kijken naar de invloed van schermgebruik op de gemiddelde hartslag tijdens de slaap. Omdat we als proefpersonen biologisch erg van elkaar verschillen (de een heeft van zichzelf een veel lagere hartslag dan de ander), moeten we hier in de statistiek voor corrigeren. 

We maken daarom twee lineaire regressiemodellen met de `lm()` functie:
1. Een basismodel waarin we alleen kijken naar de schermuren en de hartslag van de groep.
2. Een uitgebreid model waarin we ook de factor `proefpersoon` toevoegen. 

Door de factor proefpersoon mee te nemen, voorkomen we dat veranderende p-waarden voor verkeerde conclusies zorgen. Zo meten we het échte effect van de telefoon binnen de persoon zelf.
