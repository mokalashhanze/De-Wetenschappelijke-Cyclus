...
In dit onderzoek kijken we naar de relatie tussen rusthartslag en gemiddelde hartslag tijdens de slaap.

H0 (nulhypothese): Er is geen verband tussen de rusthartslag en de gemiddelde hartslag tijdens de slaap.
H1 (alternatieve hypothese): Er is wel een verband tussen de rusthartslag en de gemiddelde hartslag tijdens de slaap. Een hogere rusthartslag gaat samen met een hogere gemiddelde hartslag tijdens de slaap.
---
...
Daarom focussen wij ons op de gemiddelde hartslag tijdens de slaap als een maat voor slaapkwaliteit. Een lagere hartslag tijdens de slaap duidt op een betere slaapkwaliteit, omdat het aangeeft dat het lichaam goed tot rust komt en herstelt (Cleveland Clinic, 2024).
...
Daarnaast is ook laatste eten als snack significant (p = 0.035) en de dagelijkse stappen (p = 0.02). Deze waarden zijn wel een stuk hoger dan de andere p-waarde, dus minder betrouwbaar.
...
- Wellicht dat iemand met een lagere rusthartslag ook een lagere gemiddelde hartslag tijdens slaap heeft. Ik voeg de persoon als factor toe in het model, zodat er rekening wordt gehouden met verschillen tussen personen.
...
- Het toevoegen van persoon als factor laat zien dat er grote verschillen tussen personen zijn, en dat de individuele variabelen niet sterk genoeg zijn om deze verschillen te verklaren.
...
```{r echo=FALSE, out.width="80%"}
knitr::include_graphics("Grafieken/slaap_score_hartslag_overdag.png")
```
...
Vanwege de onbetrouwbaarheid van de gecorrigeerde slaapscore zal alleen de gemiddelde hartslag tijdens slaap als indicator voor slaapkwaliteit genomen worden in plaats van de gecorrigeerde slaapscore.
...
```{r echo=FALSE, out.width="80%"}
knitr::include_graphics("Grafieken/eten_grafiek_2.png")
```
...
```{r echo=FALSE, out.width="80%"}
knitr::include_graphics("Grafieken/gemiddelde_rusthartslag.png")
```
```{r echo=FALSE, out.width="30%", fig.cap="Gemiddelde rusthartslag per persoon"}
knitr::include_graphics("Grafieken/rusthartslag_average.png")
```
...
Dit geeft aan dat het effect van rusthartslag op gemiddelde hartslag tijdens slaap op groepsniveau sterk is, maar dat er grote individuele verschillen zijn die dit verband binnen personen moeilijk detecteerbaar maken.
...
``` 
```{r echo=FALSE, out.width="80%"}
knitr::include_graphics("Grafieken/rusthartslag_vs_stappen.png")
```
...
Ook de grafiek van rusthartslag versus stappen laat een klein verband per persoon zien, maar een groter verband op groepsniveau: meer stappen gaan samen met een lagere rusthartslag, wat weer samenhangt met een lagere hartslag tijdens slaap.
...
rusthartslag en aantal stappen op groepsniveau duidelijk samenhangen met de gemiddelde hartslag tijdens slaap.
personen met meer stappen gemiddeld ook een lagere rusthartslag hebben, wat opnieuw wijst op het belang van rusthartslag voor de hartslag tijdens slaap.
deze verbanden niet hetzelfde blijven binnen personen, door grote verschillen tussen mensen.
de gemiddelde hartslag tijdens slaap een stabielere en betrouwbaardere maat is dan de Fitbit-slaapscore.
en dat de Fitbit-slaapscore vooral REM-slaap weerspiegelt, en daarom met voorzichtigheid bekeken moet worden.

Door het kleine aantal dagen zijn de resultaten op individueel niveau niet significant. Voor sterkere conclusies op individueel niveau is vervolgonderzoek nodig met meer proefpersonen en meer metingen per persoon.
Wel laat dit onderzoek duidelijk zien hoe dagelijkse beweging, rusthartslag en persoonlijke verschillen samenhangen met hartslag en slaapkwaliteit, en hoe belangrijk het is om bij slaaponderzoek rekening te houden met de beperkingen van trackers zoals de Fitbit.