...
## 3. Analyse van gemiddelde slaaphartslag

### Waarom we de slaapscore minder gebruiken

De Fitbit-slaapscore lijkt in deze data minder betrouwbaar, omdat die score sterk meebeweegt met de gemeten slaapduur. Die slaapduur is niet altijd precies genoeg. Daardoor kan een nacht onterecht hoger of lager scoren, terwijl de echte slaapkwaliteit niet zoveel verschilt. Daarom kiezen we hier vooral voor de **gemiddelde hartslag tijdens de slaap** als uitkomstmaat. Daarbij gebruiken we de slaaptijden die de proefpersonen zelf in de Google Form hebben ingevuld.

### Meervoudige lineaire regressie

We hebben eerst een meervoudige lineaire regressie gedaan met gemiddelde slaaphartslag als uitkomst. In dit model zaten gemiddelde hartslag overdag, rusthartslag, slaapduur, REM-slaap, diepe slaap, stressmanagement, calorieën, tijd tussen telefoon en slapen en tijd tussen laatste maaltijd en slapen.

Het model had een **adjusted R² van 0.82**. Dat betekent dat dit model een groot deel van de verschillen in gemiddelde slaaphartslag kan verklaren. Dat is een sterk resultaat. Het laat zien dat deze variabelen samen veel informatie geven over de slaaphartslag tijdens de slaap.

![Meervoudige lineaire regressie gemiddelde slaaphartslag](Grafieken/Meervoudige%20Lineaire%20Regressie%20%E2%80%94%20Gemiddelde%20Slaaphartslag.png)

![R2 Meervoudige lineaire regressie gemiddelde slaaphartslag](Grafieken/R%5E2%20Meervoudige%20Lineaire%20Regressie%20%E2%80%94%20Gemiddelde%20Slaaphartslag.png)

### R² per variabele

Als je naar de losse variabelen kijkt, zie je dat geen enkele variabele alleen al heel veel verklaart. Voor de gemiddelde slaaphartslag is de R² van de losse variabelen meestal laag tot middelmatig. De hoogste losse waarden komen vooral van de rusthartslag, de laatste maaltijd en de diepe slaap. Dat betekent dat één losse factor meestal niet genoeg is om de slaaphartslag goed te verklaren, maar dat meerdere factoren samen wel veel beter werken.

![R2 per variabele](Grafieken/R%5E2%20per%20variabele.png)

### Gemiddelde slaaphartslag vs gemiddelde hartslag overdag

De grafiek van gemiddelde slaaphartslag tegenover gemiddelde hartslag overdag laat een zwakke tot matige samenhang zien. De p-waarde is hier **niet significant**. Dat betekent dat we op basis van deze plot geen sterk bewijs hebben dat een hogere hartslag overdag direct samenhangt met een hogere hartslag tijdens de slaap.

![Gemiddelde hartslag slaap vs gemiddelde hartslag overdag](Grafieken/Gemiddelde%20hartslag%20slaap%20vs%20gemiddelde%20hartslag%20overdag%20combined.png)

### Gemiddelde slaaphartslag vs rusthartslag

Bij de grafiek van gemiddelde slaaphartslag tegenover rusthartslag is de samenhang duidelijker. Hier is de p-waarde **wel significant**. Dat betekent dat rusthartslag in deze dataset echt samenhangt met de gemiddelde hartslag tijdens de slaap.

Maar zodra we `naam` als factor toevoegen, verdwijnt die significantie. Dan zien we dus dat het effect vooral op groepsniveau aanwezig is, maar niet sterk genoeg is binnen elke persoon apart. Ook is te zien dat de verschillen per persoon groot zijn en dat er veel spreiding in de data zit.

![Gemiddelde hartslag slaap vs gemiddelde rusthartslag](Grafieken/Gemiddelde%20hartslag%20slaap%20vs%20gemiddelde%20rusthartslag.png)

### Gemiddelde slaaphartslag met naam als factor

In het model met `naam` als factor stijgt de verklaarde variantie wel, maar er blijft veel verschil tussen personen. De p-waarden van de losse variabelen zijn dan niet meer onder 0.05. Dat laat zien dat het verband vooral tussen personen zit en niet sterk genoeg is binnen één persoon.

![Meervoudige lineaire regressie gemiddelde slaaphartslag + naam als factor](Grafieken/Meervoudige%20Lineaire%20Regressie%20%E2%80%94%20Gemiddelde%20Slaaphartslag%20%2B%20Naam%20als%20factor.png)

![R2 meervoudige lineaire regressie gemiddelde slaaphartslag + naam als factor](Grafieken/R%5E2%20Meervoudige%20Lineaire%20Regressie%20%E2%80%94%20Gemiddelde%20Slaaphartslag%20%2B%20Naam%20als%20factor.png)

### Gemiddelde slaaphartslag vs stressmanagementscore

De grafiek van gemiddelde slaaphartslag tegenover stressmanagementscore laat geen duidelijk patroon zien. De punten liggen verspreid en er is geen sterke lijn zichtbaar. Ook de statistiek laat hier geen significant verband zien. Dit is een goed voorbeeld van een variabele die in deze dataset weinig verklaart.

![Gemiddelde hartslag slaap vs stressmanagementscore](Grafieken/gemiddelde%20hartslag%20slaap%20vs%20stressmanagementscore.png)

### Conclusie van deze analyse

De belangrijkste uitkomst is dat de gemiddelde slaaphartslag beter werkt als maat voor slaapkwaliteit dan de Fitbit-slaapscore. De slaapscore is minder betrouwbaar doordat slaapduur daarin te zwaar meetelt. De meervoudige lineaire regressie laat zien dat meerdere variabelen samen veel kunnen verklaren, maar dat losse variabelen vaak weinig zeggen. Rusthartslag is de duidelijkste losse voorspeller van de gemiddelde slaaphartslag. Gemiddelde hartslag overdag heeft in deze data geen significant effect. Stressmanagement laat ook geen duidelijk verband zien. Daarom is de gemiddelde hartslag tijdens slaap de beste keuze voor de verdere analyse in deze paper.
